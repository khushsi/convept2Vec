...
def indirect_cosine_sim(text1, text2):
...
t2w_dataset.bookname = ['iir-','wikitest-']
for row in reader:
...
if __name__ == '__main__':
    ...
    concept_folders = {}
    concept_folders[DIRECT_VECTOR] = ['LDA200','LDA300','LDA400','LDA500','UNIGRAM']
    ...
    for dataset in test_datasets:
        for type in concept_folders.keys():
            for ir_folder in concept_folders[type]:
                print(dataset.name, type, ir_folder)
