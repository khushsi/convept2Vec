...
if __name__ == '__main__':
    ...
    irfolders = ["mgTFIDF1310", "mgTFIDF1320","gTFIDF1310", "gTFIDF1320", "wikimergeall", "wikiacm", "greedy-acm", "UNIGRAM_NOSTEM", "TFIDFNPWP1310",
                 "TFIDFNPWP1320", "TFIDF1310", "TFIDF1320", "wikiacm", "LDA10", "LDA20", "LDA30", "LDA40", "LDA50",
                 "LDA60", "LDA70", "UNIGRAM_NOSTEM", "UNIGRAM", "TFIDFNPWP1310", "gTFIDFNPWP1310", "CopyRNNRevised",
                 "TFIDFNPWP1305", "gTFIDFNPWP1305", "greedy-wiki", "TFIDF1210", "TFIDF1310", "gTFIDF1310", "LDA180",
                 "gold_E2v", "wikimergeall", "wikiitalic", "wikiacm", "greedy-acm", "CopyRNN"]
    ...
    for ir_directory in irfolders:
        ...
        wikiobj = {}
        fcount={}
        wikifiles = ["Bias-variance tradeoff.txt.phrases",
                     "Bias-variance_tradeoff.phrases",
                     "Controlled_vocabulary.txt.phrases",
                     "Controlled vocabulary.txt.phrases",
                     "Data compression.txt.phrases",
                     "Data mining.txt.phrases",
                     "Data modeling.txt.phrases",
                     "Data pre-processing.txt.phrases",
                     "Document classification.txt.phrases",
                     "Document clustering.txt.phrases",
                     "Evaluation measures (information retrieval).txt.phrases",
                     "Evaluation of binary classifiers.txt.phrases",
                     "Extended Boolean model.txt.phrases",
                     "Feature Selection Toolbox.txt.phrases",
                     "Feature selection.txt.phrases",
                     "Heaps' law.txt.phrases",
                     "Information retrieval.txt.phrases",
                     "K-means clustering.txt.phrases",
                     "K-nearest neighbors algorithm.txt.phrases",
                     "Language model.txt.phrases",
                     "Lemmatisation.txt.phrases",
                     "Multiclass classification.txt.phrases",
                     "Naive Bayes classifier.txt.phrases",
                     "Nearest centroid classifier.txt.phrases",
                     "Nearest neighbor.txt.phrases",
                     "Phrase search.txt.phrases",
                     "Probabilistic relevance model.txt.phrases",
                     "Query understanding.txt.phrases",
                     "Relevance feedback.txt.phrases",
                     "Search data structure.txt.phrases",
                     "Search engine indexing.txt.phrases",
                     "Skip list.txt.phrases",
                     "Speech disorder.txt.phrases",
                     "Spell checker.txt.phrases",
                     "Standard Boolean model.txt.phrases",
                     "Stemming.txt.phrases",
                     "Stop words.txt.phrases",
                     "Text segmentation.txt.phrases",
                     "Tf-idf.txt.phrases",
                     "Vector space model.txt.phrases",
                     "Wildcard character.txt.phrases",
                     "Zipf's law.txt.phrases"]
