...
if __name__ == '__main__':
    ...
    irfolders = ["mgTFIDF1340","mgTFIDFNPWP1340","mgTFIDFNPWP1330","mgTFIDFNPWP1310","mgTFIDFNPWP1320","mgTFIDF1330","mgTFIDF1310", "mgTFIDF1320"]
    ...
    for ir_directory in irfolders:
        ...
        for filename in os.listdir(ir_directory):
            ...
            if filename.endswith('phrases') and filename in wikifiles:
                # print(filename)
                filenamek = filename.split(".")[0].replace(" ","_")
        ...
        VSMDIR = '/Users/khushsi/Downloads/concept_extraction/acm_dl/src/keyphrase_output_199/wgVSM/'
