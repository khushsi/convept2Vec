...
if __name__ == '__main__':
    ...
    irfolders = ["wUNIGRAM","mUNIGRAM","mgTFIDF1340","mgTFIDFNPWP1340","mgTFIDFNPWP1330","mgTFIDFNPWP1310","mgTFIDFNPWP1320","mgTFIDF1330","mgTFIDF1310", "mgTFIDF1320"]
    irfolders = ["mgTFIDF1340","mgTFIDFNPWP1340","mgTFIDFNPWP1330","mgTFIDFNPWP1310","mgTFIDFNPWP1320","mgTFIDF1330","mgTFIDF1310", "mgTFIDF1320",'mwikiacm', 'mwikimergeall', 'mwikilink', 'mwikisection', 'mwikiitalic', 'mgreedy-acm', 'mgreedy-wiki',"mUNIGRAM"]
    ...
    for ir_directory in irfolders:
            ...
            if filename.endswith('phrases') and filename.startswith('iir') :
                ...
                with open(ir_directory+filename,'r') as irfile:
                    for line in irfile.readlines():
                        ...
                        fileobj[filenamek].append(concept)
            ...
            if filename.endswith('phrases') and filename.startswith('mir'):
                ...
                with open(ir_directory+filename,'r') as irfile:
                    ...
                    for line in irfile.readlines():
                        line = line.split(",")[0]
                        concept = multiwordstem(' '.join(line.lower().split()))
                        wikiobj[filenamek].append(concept)
        ...
        for doc in fileobj.keys():
            ...
            for wiki in wikiobj.keys():
                docwikiscore[doc].put((cosine_sim(' '.join(fileobj[doc]),' '.join(wikiobj[wiki]) ) ,wiki))
