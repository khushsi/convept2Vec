...
import os
import archive
from archive import preprocess
...
raw_data_path = conf.path_raw_data
raw_dict_path = conf.path_raw_data_dict
...
if filter_rest:
    if os.path.exists(restaurant_of_interest_path):
        ...
        path_prod = "".join((datahome, "data/yelp_academic_dataset_business.json"))
